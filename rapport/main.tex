...
\begin{wrapfigure}{r}{0.2\textwidth} % 'r' pour right, 0.4 = 40% de la largeur de page
    \vspace{-1.5cm}
    \centering
...
\begin{figure}[htbp] 
    \centering
    \includegraphics[width=0.4\textwidth]{images/test_andra.png}
    \caption{Première tentative de cartographie des tunnels.}
    \label{fig:carto_tunnels}
\end{figure}
...
\begin{figure}[htbp] 
    \centering
    \includegraphics[width=0.4\textwidth]{images/screen_rviz.png}
    \caption{Screen RViz}
    \label{fig:rviz}
\end{figure}
