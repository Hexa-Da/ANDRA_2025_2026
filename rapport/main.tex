...
\begin{itemize}
    ...
    \item \textbf{Cartographie via SLAM :} La création de carte via SLAM est déjà implémentée, cependant nous ne maîtrisons pas encore pleinement son fonctionnement et son paramétrage.
    \item \textbf{Positionnement par AMCL :} D'après l'équipe 2024-2025, l'utilisation d'AMCL pour la localisation du robot sur une carte préétablie est la solution appropriée, à mettre en place maintenant que le LiDAR est opérationnel.
\end{itemize}
