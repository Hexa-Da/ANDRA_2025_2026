...
\begin{frame}{Contraintes et Limitations Actuelles}
    \begin{itemize}
        ...
        \item[\textbf{--}] \textbf{Localisation :} La chaîne complète (création de carte + navigation) reste à maitriser.

        \item[\textbf{--}] \textbf{LIDAR :} Problème de matériel qui nous empeche de créer des cartes.
    \end{itemize}
\end{frame}
