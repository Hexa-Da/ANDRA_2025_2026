#!/usr/bin/env python3
"""Lance navigation autonome + sequence video en parallele."""
...
def _start(command):
    # Nouveau groupe de processus pour arrêter proprement ros2 + enfant(s).
...
def main():
    parser = argparse.ArgumentParser(
        description='Fusion navigation autonome + sequence video'
    )
    parser.add_argument(
        '--waypoints-file',
    ...
    try:
        ...
        video_process = _start(video_cmd)
        ...
        while True:
            ...
            video_status = video_process.poll() if video_process else None
